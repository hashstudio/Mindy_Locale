...
class LocalizedFormatter extends Formatter
{
     ...
     * @param Locale|string $locale an instance of CLocale or a locale ID
     */
    ...
    /**
     * @return Locale $locale the locale currently used for formatting values
     */
    public function getLocale()
    {
        if ($this->_locale === null) {
            $this->setLocale(Mindy::app()->locale);
        }
        return $this->_locale;
    }

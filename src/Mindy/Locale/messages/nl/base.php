...
return [
    'Unable to upload the file "{file}" because of an unrecognized error.' => 'Kon het bestand "{file}" niet opladen vanwege een onbekende fout.',
    '"{path}" is not a valid directory.' => '"{path}" is geen geldige map.',
    '&lt; Previous' => '&lt; Vorige',
    '&lt;&lt; First' => '&lt;&lt; Eerste',
    'A PHP extension stopped the file upload.' => 'Het opladen van het bestand werd gestopt door een PHP extensie.',
    ...
    'CProfileLogRoute found a mismatching code block "{token}". Make sure the calls to Mindy::beginProfile() and Mindy::endProfile() be properly nested.' => 'CProfileLogRoute heeft een niet overeenkomstig cod blok "{token}" gevonden. Zorg ervoor dat alle aanroepen naar Mindy::beginProfile() en Mindy::endProfile() correct genesteld zijn.',
    ...
    'Unable to generate random string.' => 'Kon geen willekeurige string aanmaken',
